...
<h3>The Double Cluster in Perseus</h3>
 <img class="fit-picture" src="https://apod.nasa.gov/apod/image/2110/doubleclustergroves1024.jpg"">


<p style="text-align: justify;">This pretty starfield spans about three full moons (1.5 degrees) across the heroic northern constellation of Perseus. It holds the famous pair of open star clusters, h and Chi Persei. Also cataloged as NGC 869 (top) and NGC 884, both clusters are about 7,000 light-years away and contain stars much younger and hotter than the Sun.  Separated by only a few hundred light-years, the clusters are both 13 million years young based on the ages of their individual stars, evidence that they were likely a product of the same star-forming region. Always a rewarding sight in binoculars, the Double Cluster is even visible to the unaided eye from dark locations. But a shroud of guitar strings was used to produced diffraction spikes on the colorful stars imaged in this vibrant telescopic view.   Global Moon Party:  Including APOD&#39;s Best Moon Images: Saturday, October 9</p>
